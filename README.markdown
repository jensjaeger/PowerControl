PowerControl: Java-Software (Kommandozeile) zum Auslesen und Schalten der [Net-PwrCtrl](http://www.anel-elektronik.de/english/Produkte/products.html) Steckdosenleisten:
==========================================
