...
public class HTTPSwitchTest extends TestCase
{
    private static final int CURCUIT_TIME_IN_MS = 250;
    ...
    public void setUp() throws Exception
    {
        ...
        parameters.host = "http://192.168.1.13";
    ...
    {
        HTTPSwitch httpSwitch = new HTTPSwitch();

        try
        {
            PowerControlState udpResult = httpSwitch.queryPowerControl(parameters);
    ...
    public void testQueryPowerControlWithXmlResult()
    {
        ...
        try
        {
            ...
            PowerControlState state = httpSwitch.queryPowerControl(parameters);
    ...
    public void testSwitchPowerControlAndQueryWithXml()
    {
        ...
        try
        {
            ...
            parameters.outlet = 1;
            httpSwitch.switchPowerControl(parameters);
            parameters.outlet = 2;
            httpSwitch.switchPowerControl(parameters);
            parameters.outlet = 3;
            httpSwitch.switchPowerControl(parameters);
            Thread.sleep(CURCUIT_TIME_IN_MS);
            validateOutletStates(httpSwitch, SwitchCommand.OFF, SwitchCommand.OFF, SwitchCommand.OFF);
            ...
            httpSwitch.switchPowerControl(parameters);
            Thread.sleep(CURCUIT_TIME_IN_MS);
            validateOutletStates(httpSwitch, SwitchCommand.ON, SwitchCommand.OFF, SwitchCommand.OFF);
            ...
            httpSwitch.switchPowerControl(parameters);
            Thread.sleep(CURCUIT_TIME_IN_MS);
            validateOutletStates(httpSwitch, SwitchCommand.ON, SwitchCommand.ON, SwitchCommand.OFF);
            ...
            httpSwitch.switchPowerControl(parameters);
            Thread.sleep(CURCUIT_TIME_IN_MS);
            validateOutletStates(httpSwitch, SwitchCommand.ON, SwitchCommand.ON, SwitchCommand.ON);
    ...
    public void testTogglePowerControlAndQueryWithXml()
    {
        ...
        try
        {
            ...
            httpSwitch.switchPowerControl(parameters);
            Thread.sleep(CURCUIT_TIME_IN_MS);
            validateOutletStates(httpSwitch, SwitchCommand.OFF, SwitchCommand.ON, SwitchCommand.OFF);
            ...
            httpSwitch.switchPowerControl(parameters);
            Thread.sleep(CURCUIT_TIME_IN_MS);
            validateOutletStates(httpSwitch, SwitchCommand.OFF, SwitchCommand.OFF, SwitchCommand.ON);
    ...
    private void validateOutletStates(HTTPSwitch httpSwitch, SwitchCommand o1, SwitchCommand o2, SwitchCommand o3)
                    throws Exception
    {
        parameters.outputToXml = true;
        PowerControlState state = httpSwitch.queryPowerControl(parameters);
